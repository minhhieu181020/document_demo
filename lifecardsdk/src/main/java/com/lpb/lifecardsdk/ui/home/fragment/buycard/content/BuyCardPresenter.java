...
public class BuyCardPresenter implements BuyCardContract.Presenter {
    private Context mContext;
    private BuyCardContract.View mViewModel;

    BuyCardPresenter(Context context, BuyCardContract.View viewModel) {
    ...
    @Override
    public void getDataCategory(final boolean isFirst) {
    ...
    @Override
    public void getDataCard(Integer categoryID, String keywordQuery, String sort, String mobilePhone, final int pageIndex, int pageSize, final boolean isFirst, final boolean... isRefresh) {
