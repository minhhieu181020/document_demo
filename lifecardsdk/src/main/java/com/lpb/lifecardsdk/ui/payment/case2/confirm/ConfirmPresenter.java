...
public class ConfirmPresenter implements ConfirmContract.Presenter {
    ...
    public void getBill(String phoneNumber, String customerName, String defCardCode) {
        final String functionName = Function.FunctionName.INIT_PAYMENT_CASE_2;
        final String functionCode = Function.FunctionCode.INIT_PAYMENT_CASE_2;

        String body = StringUtils.convertObjectToBase64(new InitPaymentRequest(phoneNumber,customerName,defCardCode));
