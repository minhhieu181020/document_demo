...
public class ProviderPresenter implements ProviderContract.Presenter {
    ...
    private ProviderContract.View mViewModel;

    ProviderPresenter(Context mContext, ProviderContract.View mViewModel) {
    ...
    @Override
    public void getDataProvider(String providerID) {
        final String functionName = Function.FunctionName.GET_DATA_PROVIDER;
        final String functionCode = Function.FunctionCode.GET_DATA_PROVIDER;

        String body = StringUtils.convertObjectToBase64(new ProviderRequest("", providerID));
            ...
            public void onResponse(Call<ResponseBase64> call, Response<ResponseBase64> response) {
                ...
                if (status.equals(Exception.Type.SUCCESS)) {
                    ...
                    try {
                        ...
                        mViewModel.setDataProvider(providerResponse);
