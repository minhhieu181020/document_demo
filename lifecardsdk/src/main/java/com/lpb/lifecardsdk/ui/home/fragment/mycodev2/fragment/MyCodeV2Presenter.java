...
public class MyCodeV2Presenter implements MyCodeV2Contract.Presenter {
    private Context mContext;
    private MyCodeV2Contract.ViewModel mViewModel;

    MyCodeV2Presenter(Context context, MyCodeV2Contract.ViewModel viewModel) {
            ...
            public void onResponse(Call<ResponseBase64> call, Response<ResponseBase64> response) {
                ...
                if (s.equals(Exception.Type.SUCCESS)) {
                    ...
                    try {
                        ...
                        mViewModel.setDataListCard(null);
                    }
