...
import com.lpb.lifecardsdk.data.model.response.default_.defcard.PromotionDto;
...
public class PromotionAdapter extends RecyclerView.Adapter<PromotionAdapter.ViewHolder> {
    ...
    PromotionAdapter(Context context, List<PromotionDto> promotionDtos, String code, DefCardAdapter.OnClickPromotion onClickPromotion) {
