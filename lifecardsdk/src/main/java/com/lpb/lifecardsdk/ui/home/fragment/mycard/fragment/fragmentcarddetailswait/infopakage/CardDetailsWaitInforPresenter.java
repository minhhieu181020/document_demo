...
public class CardDetailsWaitInforPresenter implements CardDetailsWaitInforContract.Presenter {
    private Context mContext;
    private CardDetailsWaitInforContract.View mViewModel;

    public CardDetailsWaitInforPresenter(Context mContext, CardDetailsWaitInforContract.View mViewModel) {
    ...
    public void getDataInforCard(String mobilePhone, String code) {
        final String functionName = Function.FunctionName.PACKAGE_SERVICE_DETAILS_MY_CARD;
        final String functionCode = Function.FunctionCode.PACKAGE_SERVICE_DETAILS_MY_CARD;
