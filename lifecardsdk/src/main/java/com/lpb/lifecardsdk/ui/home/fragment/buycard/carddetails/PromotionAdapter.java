...
public class PromotionAdapter extends RecyclerView.Adapter<PromotionAdapter.ViewHolder> {
    private List<PackageDetailResponse.PromotionDto> promotionDtos;
    private Context context;

   public PromotionAdapter(Context context, List<PackageDetailResponse.PromotionDto> promotionDtos) {
