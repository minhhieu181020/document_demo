...
public class ListCardServiceAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>  {
    private List<ListServicePaymentQrBillResponse.ServiceDetailData> listCardServices;
    ...
    public ListCardServiceAdapter(Context context) {
        this.listCardServices = new ArrayList<>();
        this.context = context;
    }

    public void addItems(List<ListServicePaymentQrBillResponse.ServiceDetailData> items) {
        listCardServices.addAll(items);
        notifyDataSetChanged();
    }

    public void setItems(List<ListServicePaymentQrBillResponse.ServiceDetailData> items) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        if (viewHolder instanceof ViewHolder) {
            final ListServicePaymentQrBillResponse.ServiceDetailData listCardService = listCardServices.get(i);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void onBindData(final ListServicePaymentQrBillResponse.ServiceDetailData listCardService) {
    ...
    public interface OnClickListener {
        void onClick(ListServicePaymentQrBillResponse.ServiceDetailData item);
    }
}
