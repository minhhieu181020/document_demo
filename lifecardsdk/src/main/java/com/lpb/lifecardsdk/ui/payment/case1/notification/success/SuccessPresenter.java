...
public class SuccessPresenter implements SuccessContract.Presenter {
    private Context mContext;
    private SuccessContract.View mViewModel;

    SuccessPresenter(Context mContext, SuccessContract.View mViewModel) {
    ...
    public void getPaymentResult(String mobilePhone, String orderNo, String paymentStatus) {
        final String functionName = Function.FunctionName.GET_PAYMENT_RESULT_SUCCESS_C1;
        final String functionCode = Function.FunctionCode.GET_PAYMENT_RESULT_SUCCESS_C1;
