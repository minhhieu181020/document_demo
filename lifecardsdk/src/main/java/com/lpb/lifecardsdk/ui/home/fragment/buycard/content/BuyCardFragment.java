...
public class BuyCardFragment extends BaseDataFragment<BuyCardPresenter> implements BuyCardContract.View {
...
//    private EditText edMinPrice, edMaxPrice;
    ...
    private com.lpb.lifecardsdk.ui.home.fragment.buycard.content.adapter.CategoryAdapter categoryAdapterMain;
...
//        rvContent.setNestedScrollingEnabled(false);
        ...
        categoryAdapterMain = new com.lpb.lifecardsdk.ui.home.fragment.buycard.content.adapter.CategoryAdapter(mActivity);
    ...
    protected void initData() {
        mPresenter = new BuyCardPresenter(mActivity, this);
        if (PresenterUtils.isNetworkConnected(mActivity)) {
            showLoading(true);
            mPresenter.getDataCategory(true);
            mPresenter.getDataCard(categoryID, "", Constants.SortType.MN, LCConfig.getPhoneNumber(), pageIndex, pageSize, true);
        } else {
    ...
    private void refreshData() {
        if (PresenterUtils.isNetworkConnected(mActivity)) {
            ...
            mPresenter.getDataCategory(false);
            mPresenter.getDataCard(categoryID, "", sortType, LCConfig.getPhoneNumber(), pageIndex, pageSize, false);
        } else {
            setRefreshing(false);
    ...
    protected void initAction() {
        ...
        rvContent.addOnScrollListener(new EndlessRecyclerViewScrollListener(linearLayoutManager) {
            ...
            public void onLoadMore(int page, int totalItemsCount, RecyclerView view) {
                mPresenter.getDataCard(categoryID, "", sortType, LCConfig.getPhoneNumber(), page + 1, pageSize, false);
            }
        });
...
//        });
        ...
        buyCardAdapter.setOnClickListener(new BuyCardAdapter.OnClickListener() {
            ...
            public void onClickBuyCard(PackageSearchResponse.DefCardDto item) {
                if (!isClicked) {
                    ...
                    MainBuyCardFragment.getInstance().addFragment(cardDetailsFragment, BuyCardFragment.this);
                    startTimer();
                }
            }
        });
        buyCardAdapter.setOnClickLogoListener(new BuyCardAdapter.OnClickLogo() {
            ...
            public void onClickItem(PackageSearchResponse.ProviderDto item) {
                ...
                MainBuyCardFragment.getInstance().addFragment(providerFragment, BuyCardFragment.this);
            }
        });
        buyCardAdapter.setOnClickPromotion(new BuyCardAdapter.OnClickPromotion() {
            @Override
        ...
        categoryAdapterMain.setOnClickListener(new com.lpb.lifecardsdk.ui.home.fragment.buycard.content.adapter.CategoryAdapter.OnClickListener() {
            @Override
...
//                MainBuyCardFragment.getInstance().addFragment(searchFragment, BuyCardFragment.this);
//            }
//        });
    }
