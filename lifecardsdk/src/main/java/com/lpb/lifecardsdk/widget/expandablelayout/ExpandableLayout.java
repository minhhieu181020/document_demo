package com.lpb.lifecardsdk.widget.expandablelayout;
...
import static com.lpb.lifecardsdk.widget.expandablelayout.ExpandableLayout.State.COLLAPSED;
import static com.lpb.lifecardsdk.widget.expandablelayout.ExpandableLayout.State.COLLAPSING;
import static com.lpb.lifecardsdk.widget.expandablelayout.ExpandableLayout.State.EXPANDING;
import static com.lpb.lifecardsdk.widget.expandablelayout.ExpandableLayout.State.EXPANDED;
...
public class ExpandableLayout extends FrameLayout {
    ...
    public ExpandableLayout(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.LifeCardSDK_ExpandableLayout);
            duration = a.getInt(R.styleable.LifeCardSDK_ExpandableLayout_el_duration, DEFAULT_DURATION);
            expansion = a.getBoolean(R.styleable.LifeCardSDK_ExpandableLayout_el_expanded, false) ? 1 : 0;
            orientation = a.getInt(R.styleable.LifeCardSDK_ExpandableLayout_android_orientation, VERTICAL);
            parallax = a.getFloat(R.styleable.LifeCardSDK_ExpandableLayout_el_parallax, 1);
            a.recycle();
