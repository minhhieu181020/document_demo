package com.lpb.lifecardsdk.widget.autofilltextview;
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            TypedArray ta = context.obtainStyledAttributes(
                    attrs,
                    R.styleable.LifeCardSDKAutofitTextView,
                    defStyle,
                    0);
            sizeToFit = ta.getBoolean(R.styleable.LifeCardSDKAutofitTextView_LifeCardSDK_SizeToFit, sizeToFit);
            minTextSize = ta.getDimensionPixelSize(R.styleable.LifeCardSDKAutofitTextView_LifeCardSDK_MinTextSize,
                    minTextSize);
            precision = ta.getFloat(R.styleable.LifeCardSDKAutofitTextView_LifeCardSDK_Precision, precision);
            ta.recycle();
        }
