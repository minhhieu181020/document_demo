...
public class SDKConfiguration implements Serializable {
    ...
    SDKConfiguration(SDKConfiguration.Builder builder) {
    ...
    public static class Builder {
        ...
        public SDKConfiguration.Builder setEnableSound(Boolean isEnable) {
            this.isEnableSound = isEnable;
            return this;
        }

        public SDKConfiguration.Builder setLivenessMode(LivenessMode livenessMode) {
            this.livenessMode = livenessMode;
            return this;
        }

        public SDKConfiguration.Builder setActionMode(ActionMode actionMode) {
            this.actionMode = actionMode;
            return this;
        }

        public SDKConfiguration.Builder setCardType(CardType cardType) {
            this.cardType = cardType;
            return this;
        }

        public SDKConfiguration.Builder setCameraOption(CameraOption cameraOption) {
            this.cameraOption = cameraOption;
            return this;
        }

        public SDKConfiguration.Builder setEnableIDSanityCheck(boolean enableIDSanityCheck) {
            this.isEnableIDSanityCheck = enableIDSanityCheck;
            return this;
        }

        public SDKConfiguration.Builder setEnableSelfieSanityCheck(boolean enableSelfieSanityCheck) {
            this.isEnableSelfieSanityCheck = enableSelfieSanityCheck;
            return this;
        }

        public SDKConfiguration.Builder setEnableTiltChecking(boolean enableTiltChecking) {
