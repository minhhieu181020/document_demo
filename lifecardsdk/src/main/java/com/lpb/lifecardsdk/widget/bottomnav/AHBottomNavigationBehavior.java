...
public class AHBottomNavigationBehavior<V extends View> extends VerticalScrollingBehavior<V> {
	...
	public AHBottomNavigationBehavior(Context context, AttributeSet attrs) {
		super(context, attrs);
		TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.LifeCardSDK_AHBottomNavigationBehavior_Params);
		mTabLayoutId = a.getResourceId(R.styleable.LifeCardSDK_AHBottomNavigationBehavior_Params_tabLayoutId, View.NO_ID);
		a.recycle();
	}
