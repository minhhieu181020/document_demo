package com.lpb.lifecardsdk.widget.zxing;
...
public abstract class BarcodeScannerView extends FrameLayout implements Camera.PreviewCallback  {
    ...
    @ColorInt
    private int mLaserColor = getResources().getColor(R.color.lcm_viewfinder_laser);
    @ColorInt private int mBorderColor = getResources().getColor(R.color.lcm_viewfinder_border);
    private int mMaskColor = getResources().getColor(R.color.lcm_viewfinder_mask);
    private int mBorderWidth = getResources().getInteger(R.integer.lcm_viewfinder_border_width);
    private int mBorderLength = getResources().getInteger(R.integer.lcm_viewfinder_border_length);
    ...
    public BarcodeScannerView(Context context, AttributeSet attributeSet) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(
                attributeSet,
                R.styleable.Lcm_BarcodeScannerView,
                0, 0);

        try {
            setShouldScaleToFill(a.getBoolean(R.styleable.Lcm_BarcodeScannerView_shouldScaleToFill, true));
            mIsLaserEnabled = a.getBoolean(R.styleable.Lcm_BarcodeScannerView_laserEnabled, mIsLaserEnabled);
            mLaserColor = a.getColor(R.styleable.Lcm_BarcodeScannerView_laserColor, mLaserColor);
            mBorderColor = a.getColor(R.styleable.Lcm_BarcodeScannerView_borderColor, mBorderColor);
            mMaskColor = a.getColor(R.styleable.Lcm_BarcodeScannerView_maskColor, mMaskColor);
            mBorderWidth = a.getDimensionPixelSize(R.styleable.Lcm_BarcodeScannerView_borderWidth, mBorderWidth);
            mBorderLength = a.getDimensionPixelSize(R.styleable.Lcm_BarcodeScannerView_borderLength, mBorderLength);

            mRoundedCorner = a.getBoolean(R.styleable.Lcm_BarcodeScannerView_roundedCorner, mRoundedCorner);
            mCornerRadius = a.getDimensionPixelSize(R.styleable.Lcm_BarcodeScannerView_cornerRadius, mCornerRadius);
            mSquaredFinder = a.getBoolean(R.styleable.Lcm_BarcodeScannerView_squaredFinder, mSquaredFinder);
            mBorderAlpha = a.getFloat(R.styleable.Lcm_BarcodeScannerView_borderAlpha, mBorderAlpha);
            mViewFinderOffset = a.getDimensionPixelSize(R.styleable.Lcm_BarcodeScannerView_finderOffset, mViewFinderOffset);
        } finally {
            a.recycle();
        }
