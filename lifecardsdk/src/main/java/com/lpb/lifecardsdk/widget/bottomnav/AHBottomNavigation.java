package com.lpb.lifecardsdk.widget.bottomnav;
...
public class AHBottomNavigation extends FrameLayout {
	...
	private void init(Context context, AttributeSet attrs) {
		...
		// Item colors
		titleColorActive = ContextCompat.getColor(context, R.color.lifecardsdk_colorBottomNavigationAccent);
		titleColorInactive = ContextCompat.getColor(context, R.color.lifecardsdk_colorBottomNavigationInactive);
		itemDisableColor = ContextCompat.getColor(context, R.color.lifecardsdk_colorBottomNavigationDisable);
		
		// Colors for colored bottom navigation
		coloredTitleColorActive = ContextCompat.getColor(context, R.color.lifecardsdk_colorBottomNavigationActiveColored);
		coloredTitleColorInactive = ContextCompat.getColor(context, R.color.lifecardsdk_colorBottomNavigationInactiveColored);
		
		if (attrs != null) {
			TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.LifeCardSDK_AHBottomNavigationBehavior_Params, 0, 0);
			try {
				selectedBackgroundVisible = ta.getBoolean(R.styleable.LifeCardSDK_AHBottomNavigationBehavior_Params_selectedBackgroundVisible, false);
				translucentNavigationEnabled = ta.getBoolean(R.styleable.LifeCardSDK_AHBottomNavigationBehavior_Params_translucentNavigationEnabled, false);
				
				titleColorActive = ta.getColor(R.styleable.LifeCardSDK_AHBottomNavigationBehavior_Params_accentColor,
						ContextCompat.getColor(context, R.color.lifecardsdk_colorBottomNavigationAccent));
				titleColorInactive = ta.getColor(R.styleable.LifeCardSDK_AHBottomNavigationBehavior_Params_inactiveColor,
						ContextCompat.getColor(context, R.color.lifecardsdk_colorBottomNavigationInactive));
				itemDisableColor = ta.getColor(R.styleable.LifeCardSDK_AHBottomNavigationBehavior_Params_disableColor,
						ContextCompat.getColor(context, R.color.lifecardsdk_colorBottomNavigationDisable));
				
				coloredTitleColorActive = ta.getColor(R.styleable.LifeCardSDK_AHBottomNavigationBehavior_Params_coloredActive,
						ContextCompat.getColor(context, R.color.lifecardsdk_colorBottomNavigationActiveColored));
				coloredTitleColorInactive = ta.getColor(R.styleable.LifeCardSDK_AHBottomNavigationBehavior_Params_coloredInactive,
						ContextCompat.getColor(context, R.color.lifecardsdk_colorBottomNavigationInactiveColored));
				
				colored = ta.getBoolean(R.styleable.LifeCardSDK_AHBottomNavigationBehavior_Params_colored, false);
		...
		bottomNavigationHeight = (int) resources.getDimension(R.dimen.lifecardsdk_bottom_navigation_height);
		
		itemActiveColor = titleColorActive;
		itemInactiveColor = titleColorInactive;

		// Notifications
		notificationActiveMarginLeft = (int) resources.getDimension(R.dimen.lifecardsdk_bottom_navigation_notification_margin_left_active);
		notificationInactiveMarginLeft = (int) resources.getDimension(R.dimen.lifecardsdk_bottom_navigation_notification_margin_left);
		notificationActiveMarginTop = (int) resources.getDimension(R.dimen.lifecardsdk_bottom_navigation_notification_margin_top_active);
		notificationInactiveMarginTop = (int) resources.getDimension(R.dimen.lifecardsdk_bottom_navigation_notification_margin_top);
		notificationAnimationDuration = 150;

		ViewCompat.setElevation(this, resources.getDimension(R.dimen.lifecardsdk_bottom_navigation_elevation));
	...
	private void createItems() {
		...
		int layoutHeight = (int) resources.getDimension(R.dimen.lifecardsdk_bottom_navigation_height);
	...
	private void createClassicItems(LinearLayout linearLayout) {
		...
		float height = resources.getDimension(R.dimen.lifecardsdk_bottom_navigation_height);
		float minWidth = resources.getDimension(R.dimen.lifecardsdk_bottom_navigation_min_width);
		float maxWidth = resources.getDimension(R.dimen.lifecardsdk_bottom_navigation_max_width);

		if (titleState == TitleState.ALWAYS_SHOW && items.size() > MIN_ITEMS) {
			minWidth = resources.getDimension(R.dimen.lifecardsdk_bottom_navigation_small_inactive_min_width);
			maxWidth = resources.getDimension(R.dimen.lifecardsdk_bottom_navigation_small_inactive_max_width);
		}
		...
		float activeSize = resources.getDimension(R.dimen.lifecardsdk_bottom_navigation_text_size_active);
		float inactiveSize = resources.getDimension(R.dimen.lifecardsdk_bottom_navigation_text_size_inactive);
		int activePaddingTop = (int) resources.getDimension(R.dimen.lifecardsdk_bottom_navigation_margin_top_active);
		...
		if (titleActiveTextSize != 0 && titleInactiveTextSize != 0) {
			...
			activeSize = resources.getDimension(R.dimen.lifecardsdk_bottom_navigation_text_size_forced_active);
			inactiveSize = resources.getDimension(R.dimen.lifecardsdk_bottom_navigation_text_size_forced_inactive);
		}
		...
		for (int i = 0; i < items.size(); i++) {
			...
			View view = inflater.inflate(R.layout.lifecardsdk_bottom_navigation_item, this, false);
	...
	private void createSmallItems(LinearLayout linearLayout) {
		...
		float height = resources.getDimension(R.dimen.lifecardsdk_bottom_navigation_height);
		float minWidth = resources.getDimension(R.dimen.lifecardsdk_bottom_navigation_small_inactive_min_width);
		float maxWidth = resources.getDimension(R.dimen.lifecardsdk_bottom_navigation_small_inactive_max_width);
		...
		int activeMarginTop = (int) resources.getDimension(R.dimen.lifecardsdk_bottom_navigation_small_margin_top_active);
		float difference = resources.getDimension(R.dimen.lifecardsdk_bottom_navigation_small_selected_width_difference);
		...
		for (int i = 0; i < items.size(); i++) {
			...
			View view = inflater.inflate(R.layout.lifecardsdk_bottom_navigation_small_item, this, false);
	...
	private void updateItems(final int itemIndex, boolean useCallback) {
		...
		int activeMarginTop = (int) resources.getDimension(R.dimen.lifecardsdk_bottom_navigation_margin_top_active);
		int inactiveMarginTop = (int) resources.getDimension(R.dimen.lifecardsdk_bottom_navigation_margin_top_inactive);
		float activeSize = resources.getDimension(R.dimen.lifecardsdk_bottom_navigation_text_size_active);
		float inactiveSize = resources.getDimension(R.dimen.lifecardsdk_bottom_navigation_text_size_inactive);
	...
	private void updateSmallItems(final int itemIndex, boolean useCallback) {
		...
		int activeMarginTop = (int) resources.getDimension(R.dimen.lifecardsdk_bottom_navigation_small_margin_top_active);
		int inactiveMargin = (int) resources.getDimension(R.dimen.lifecardsdk_bottom_navigation_small_margin_top);
		...
		for (int i = 0; i < views.size(); i++) {
			...
			if (updateStyle) {
				...
				if (notificationBackgroundDrawable != null) {
					...
					Drawable defautlDrawable = ContextCompat.getDrawable(context, R.drawable.lifecardsdk_bottom_nav_notification_background);
					if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
	...
	public void setUseElevation(boolean useElevation) {
		ViewCompat.setElevation(this, useElevation ?
				resources.getDimension(R.dimen.lifecardsdk_bottom_navigation_elevation) : 0);
