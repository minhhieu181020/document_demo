...
public class CameraView extends FrameLayout {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        inflate(getContext(), R.layout.lifecardsdk_camera_view, this);
    ...
    public void handleSetupFailure() {
        ...
        Exception.handleMessageRequestFailure(activity,activity.getString(R.string.lifecardsdk_cant_configure_camera),"");
        activity.finish();
    }
