...
public class CircleProgressBar extends View {
    ...
    private CircleProgressBar.ProgressFormatter mProgressFormatter;
    private int mStyle;
    private int mShader;
    ...
    public CircleProgressBar(Context context, AttributeSet attrs) {
        ...
        this.mMax = 100;
        this.mProgressFormatter = new CircleProgressBar.DefaultProgressFormatter();
        this.initFromAttributes(context, attrs);
        this.initPaint();
    }

    private void initFromAttributes(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.LifeCardSDKCircleProgressBar);
        this.mLineCount = a.getInt(R.styleable.LifeCardSDKCircleProgressBar_line_count, 45);
        this.mStyle = a.getInt(R.styleable.LifeCardSDKCircleProgressBar_style, 0);
        this.mShader = a.getInt(R.styleable.LifeCardSDKCircleProgressBar_progress_shader, 0);
        this.mCap = a.hasValue(R.styleable.LifeCardSDKCircleProgressBar_progress_stroke_cap) ? Paint.Cap.values()[a.getInt(R.styleable.LifeCardSDKCircleProgressBar_progress_stroke_cap, 0)] : Paint.Cap.ROUND;
        this.mLineWidth = (float)a.getDimensionPixelSize(R.styleable.LifeCardSDKCircleProgressBar_bar_line_width, DisplayUtils.dip2px(this.getContext(), 11.0F));
        this.mProgressTextSize = (float)a.getDimensionPixelSize(R.styleable.LifeCardSDKCircleProgressBar_progress_text_size, DisplayUtils.dip2px(this.getContext(), 11.0F));
        this.mProgressStrokeWidth = (float)a.getDimensionPixelSize(R.styleable.LifeCardSDKCircleProgressBar_progress_stroke_width, DisplayUtils.dip2px(this.getContext(), 1.0F));
        this.mProgressStartColor = a.getColor(R.styleable.LifeCardSDKCircleProgressBar_progress_start_color, Color.parseColor("#fff2a670"));
        this.mProgressEndColor = a.getColor(R.styleable.LifeCardSDKCircleProgressBar_progress_end_color, Color.parseColor("#fff2a670"));
        this.mProgressTextColor = a.getColor(R.styleable.LifeCardSDKCircleProgressBar_progress_text_color, Color.parseColor("#fff2a670"));
        this.mProgressBackgroundColor = a.getColor(R.styleable.LifeCardSDKCircleProgressBar_progress_background_color, Color.parseColor("#ffe3e3e5"));
        this.mStartDegree = a.getInt(R.styleable.LifeCardSDKCircleProgressBar_progress_start_degree, 90);
        this.mDrawBackgroundOutsideProgress = a.getBoolean(R.styleable.LifeCardSDKCircleProgressBar_drawBackgroundOutsideProgress, false);
        a.recycle();
    }
    ...
    public void setProgressFormatter(CircleProgressBar.ProgressFormatter progressFormatter) {
    ...
    public Parcelable onSaveInstanceState() {
        ...
        CircleProgressBar.SavedState ss = new CircleProgressBar.SavedState(superState);
        ss.progress = this.mProgress;
        return ss;
    }

    public void onRestoreInstanceState(Parcelable state) {
        CircleProgressBar.SavedState ss = (CircleProgressBar.SavedState)state;
    ...
    private static final class SavedState extends BaseSavedState {
        ...
        public static final Creator<SavedState> CREATOR = new Creator<SavedState>() {
            public CircleProgressBar.SavedState createFromParcel(Parcel in) {
                return new CircleProgressBar.SavedState(in);
            }

            public CircleProgressBar.SavedState[] newArray(int size) {
                return new CircleProgressBar.SavedState[size];
            }
        };
    ...
    private static final class DefaultProgressFormatter implements CircleProgressBar.ProgressFormatter {
