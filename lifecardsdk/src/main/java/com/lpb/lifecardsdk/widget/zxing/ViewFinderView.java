...
public class ViewFinderView extends View implements IViewFinder {
    ...
    private final int mDefaultLaserColor = getResources().getColor(R.color.lcm_viewfinder_laser);
    private final int mDefaultMaskColor = getResources().getColor(R.color.lcm_viewfinder_mask);
    private final int mDefaultBorderColor = getResources().getColor(R.color.lcm_viewfinder_border);
    private final int mDefaultBorderStrokeWidth = getResources().getInteger(R.integer.lcm_viewfinder_border_width);
    private final int mDefaultBorderLineLength = getResources().getInteger(R.integer.lcm_viewfinder_border_length);
